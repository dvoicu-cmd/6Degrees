...
In short: I had to design a REST API that runs on a java server that would interface with a neo4j database. The goal of the API is to organize nodes in the database and ultimately return a path from any actor node to the keven bacon node.
